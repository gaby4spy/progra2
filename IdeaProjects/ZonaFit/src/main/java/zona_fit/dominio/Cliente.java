...
public class Cliente {
    ...
    public  Cliente(int id){//constructor pensado para la eliminacion
        this.id=id;
    }

    public Cliente (String nombre,String apellido,int membresia){//pensado para la insercion
        this.nombre=nombre;
        this.apellido=apellido;
        this.membresia=membresia;
    }

    public Cliente (int id ,String nombre,String apellido,int membresia) {//pensado para la recuperacion de tipo cliente
